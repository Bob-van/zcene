...
pub const float3 = extern struct {
    v: [3]f32 = std.mem.zeroes([3]f32),
};
pub const float16 = extern struct {
    v: [16]f32 = std.mem.zeroes([16]f32),
};

pub const floorf = std.zig.c_builtins.__builtin_floorf;
pub const fabsf = std.zig.c_builtins.__builtin_fabsf;
pub const sqrtf = std.zig.c_builtins.__builtin_sqrtf;
pub const cosf = std.zig.c_builtins.__builtin_cosf;
pub const sinf = std.zig.c_builtins.__builtin_sinf;
